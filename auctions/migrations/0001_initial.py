# Generated by Django 6.0.2 on 2026-03-10 20:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='closed_auction', to='auctions.auction')),
                ('winner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='closed_auctions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
